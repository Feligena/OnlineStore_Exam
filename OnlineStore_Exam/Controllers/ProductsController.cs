...
namespace OnlineStore_Exam.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Article,Title,Prise,Description,Specification,CategoryId,IsDeleted")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Article,Title,Prise,Description,Specification,CategoryId,IsDeleted")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
